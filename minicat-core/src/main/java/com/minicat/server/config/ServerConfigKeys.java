...
public class ServerConfigKeys {
    ...
    // Http settings
    public static final String HTTP_KEEP_ALIVE_TIME = "http.keep-alive";
    ...
    public static final String DEFAULT_HTTP_KEEP_ALIVE_TIME = "35";
    public static final String DEFAULT_SERVER_MODE = "nio";
