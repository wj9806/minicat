package io.github.wj9806.minicat.core.test.ws;
...
public class EchoChannel {
    ...
    // 连接打开
    @OnOpen
    public void onOpen(Session session, EndpointConfig endpointConfig, @PathParam("key") String key) throws IOException {
        // 保存 session 到对象
        this.session = session;
        LOGGER.info("[websocket] 新的连接：id={}, key = {}", this.session.getId(), key);
